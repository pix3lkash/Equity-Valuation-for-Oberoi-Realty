...
plt.plot(revenue.index, revenue.values/1e9,
         marker='o', label="Revenue")

plt.plot(income.index, income.values/1e9,
         marker='o', label="Net Income")
...
plt.plot(tech["Date"], tech["Close"], label="Close")

plt.plot(tech["Date"], tech["SMA_50"], label="50 DMA")

plt.plot(tech["Date"], tech["SMA_200"], label="200 DMA")
...
plt.bar(values["Metric"], values["Value"]/1e9)
